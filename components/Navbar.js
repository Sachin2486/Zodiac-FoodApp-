...
export default function Navbar(props) {
    ...
    const handleLogout = () => {
        localStorage.removeItem('token') // herre again checking happens with the use of auth token 
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            {(localStorage.getItem("token")) ? // here i am checcking auth token with ternary operator for already logged in user
                                <li className="nav-item">
